...
import { faHouse, faLaptopCode, faAddressCard, faDownload, faFolderOpen} from '@fortawesome/free-solid-svg-icons';
...
const Navigation = () => {
  ...
  return (
    <Navbar fixed='top' style={{
      ...
      <Navbar.Brand className='navbar-logo'href="/"> <a id='brand-name'>DacheQL</a> <Image src={logo} width={60} height={50}/> </Navbar.Brand>
      ...
      <Navbar.Collapse id='navbar-nav'>
        <Nav className="nav-items" navbarScroll style={{ justifyContent: 'center', right: '5vw',  position:'absolute'  }}>
          ...
          <Nav.Link className='nav-item' as={Link} to='/docs' ><FontAwesomeIcon icon={faFolderOpen}></FontAwesomeIcon >&nbsp;Docs</Nav.Link>
