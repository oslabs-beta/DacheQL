      ...
      <div className='homepage'> 
        ...
        <Row className='secondbox'> 
          ...
          <Col>
            ...
            <p>We store your cached information for you in our own database and prevent excessive information from being called from the API</p>
          </Col>
          <Col> 
            <span className="material-symbols-outlined">
            install_desktop
        ...
        <Row className = 'graphql'>
          ...
          <Col>
            <div>
              ...
              <div className='fs-5'>GraphQL is an open-source data query and manipulation language for APIs, and a runtime for fulfilling queries with existing data. </div>
              <div className='fs-5'>With GraphQL, you can specify what data you want to request from your API. You will get back exactly what you need, nothing more and nothing less. GraphQL queries always return predictable results.</div>
